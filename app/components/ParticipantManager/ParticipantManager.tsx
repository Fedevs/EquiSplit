      ...
      <div className='flex flex-col items-center w-full gap-3'>
        ...
        <div className='flex justify-between gap-1'>
          ...
          <button
            ...
            className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800'
          >
            ADD
          </button>
        </div>
